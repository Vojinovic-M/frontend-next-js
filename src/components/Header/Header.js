        ...
        <header>
            <div className="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                <Link href="/" className="d-flex align-items-center text-dark text-decoration-none">
                    ...
                    <span className="fs-4">Marko's Template</span></Link>
            ...
            <div className="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 className="display-4 fw-normal">User Table</h1>
                <p className="fs-5 text-muted">Showing off the bootstrapped styling of my NextJS frontend.</p>
            </div>
        </header>
    );
}
